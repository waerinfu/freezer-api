...
def upgrade() -> None:
    op.add_column(
        ...
        sa.Column(
            ...
            server_default='["backup", "restore", "info", "admin", "exec"]',
            nullable=False,
        )
    )
    op.add_column(
        ...
        sa.Column(
            'supported_modes',
            sa.String(length=255),
            default='["fs", "mongo", "mysql", "sqlserver", "cinder", "glance",'
                    ' "cindernative", "nova"]',
            server_default='["fs", "mongo", "mysql", "sqlserver", "cinder",'
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            server_default='["local", "swift", "ssh", "s3", "ftp", "ftps"]',
            nullable=False,
        )
    )
    op.add_column(
        ...
        sa.Column(
            ...
            server_default='["tar", "rsync", "rsyncv2", "nova", "osbrick",'
                           ' "glance"]',
            nullable=False,
        )
    )
